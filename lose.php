...
<body>
    <div id="lewy">
        ...
        <p>Oto pan Dariusz.<br>Pan Dariusz ma zepsutą kamerkę bo nie posiada kamery od firmy Tutel Maciek.<br>Nie bądź
            jak pan Dariusz.<br><b>Bonusowy kod "Tutel" na -35% na pierwsze zakupy.</b></p>
    </div>
    <div id="srodek">
        <h1>PRZEGRAŁEŚ 😥</h1>
